...
if (isset($_SESSION["login_error"])) {
    ...
    if ($_SESSION["login_error"] === "username") {
        ...
        echo '<script type="text/javascript">';
        echo 'document.addEventListener("DOMContentLoaded", function() {';
        echo 'password_error(' . json_encode($_SESSION["username_attempt"]) . ',' . json_encode($_SESSION["password_attempt"]) . ');';
        echo '});';
        echo '</script>';
    }
    ...
    <body>
        ...
        <main id="page" class="container">
            <div class="w-50 position-absolute top-50 start-50 translate-middle">
                <form class="needs-validation" id="login" action="./php/authenticate.php" method="POST">
                    <legend class="text-center pb-3 fs-3 fw-bold">Log In</legend>
                    <div class="row mb-3">
