    ...
    <body>
        ...
        <main id="page" class="container">
            <div class="w-50 position-absolute top-50 start-50 translate-middle">
                ...
                <form class="needs-validation" id="change_password" action="./php/update_account.php" method="POST">
                    ...
                    <div class="row mb-3" >
                        <label for="verify_password" class="col-sm-3 col-form-label">Verify Password</label>
                        <div class="col-sm-9">
